...
Después de actualizar las variables, reinicia el backend:
...
1. Abre: https://remote-tech-support-eight.vercel.app/login
...
1. Verifica que `CORS_ORIGIN` sea exactamente: `https://remote-tech-support-eight.vercel.app`
...
Si Vercel genera URLs de preview (como `remote-tech-support-eight-git-main.vercel.app`), actualiza `CORS_ORIGIN` con:

```
https://remote-tech-support-eight.vercel.app,https://remote-tech-support-eight-*.vercel.app
```
...
- ✅ `CORS_ORIGIN` → `https://remote-tech-support-eight.vercel.app`
- ✅ `FRONTEND_URL` → `https://remote-tech-support-eight.vercel.app` (opcional)
